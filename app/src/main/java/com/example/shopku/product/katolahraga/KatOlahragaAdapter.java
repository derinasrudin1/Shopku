...
public class KatOlahragaAdapter extends RecyclerView.Adapter<KatOlahragaAdapter.ViewHolder> {
    private List<Product> productList;
    private Context context;

    public KatOlahragaAdapter(List<Product> productList, Context context) {
        this.productList = productList;
        this.context = context;
    }
    @NonNull
    @Override
    public KatOlahragaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_item, parent, false);
        return new KatOlahragaAdapter.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull KatOlahragaAdapter.ViewHolder holder, int position) {
